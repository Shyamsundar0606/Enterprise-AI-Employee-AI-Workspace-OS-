...
class ChatService:
    ...
    async def create_conversation(self, *, user_id: int, title: str) -> Conversation:
        ...
        logger.info(
            "Conversation created", extra={"user_id": user_id, "conversation_id": conversation.id}
        )
        return conversation
    ...
    async def update_conversation(
        self, *, conversation_id: str, user_id: int, fields: dict[str, Any]
    ) -> Conversation:
    ...
    async def delete_conversation(self, *, conversation_id: str, user_id: int) -> bool:
        ...
        logger.info(
            "Conversation deleted", extra={"user_id": user_id, "conversation_id": conversation_id}
        )
        return True
